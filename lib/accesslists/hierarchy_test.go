...
func TestAccessListHierarchyDepthCheck(t *testing.T) {
	...
	err := ValidateAccessListMember(ctx, acls[accesslist.MaxAllowedDepth-1].GetName(), accessListAndMembersGetter.members[acls[accesslist.MaxAllowedDepth-1].GetName()][0], accessListAndMembersGetter)
	...
	err = ValidateAccessListMember(ctx, acls[accesslist.MaxAllowedDepth].GetName(), extraMember, accessListAndMembersGetter)
	require.Error(t, err)
...
func TestAccessListHierarchyCircularRefsCheck(t *testing.T) {
	...
	err := ValidateAccessListMember(ctx, acl3.GetName(), acl3m1, accessListAndMembersGetter)
